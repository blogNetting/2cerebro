...
- [[devops-minimo]] — mínimo operativo en producción una vez desplegado: monitorización, alertado, incidentes, backup/DR, rotación de secretos, parcheo de dependencias, coste — todo anclado en un caso real y auditable de operador en solitario (Healthchecks.io)
- [[astillero-mantenimiento]] — cómo se propaga una actualización de Astillero a un proyecto ya existente (gh aw compile + copier update, PAT de scope workflow), y protocolo de convivencia entre el código de Astillero y el wiki de 2Cerebro
